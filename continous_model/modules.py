...
class SimpleNet(nn.Module):
    ...
    def __init__(self, out_features=4, type='sine', in_features=3,
                 mode='mlp', hidden_features=256, num_hidden_layers=3, fft_mode="simple", **kwargs):
        super().__init__()
        self.mode = mode
        ...
        if self.mode == 'rbf':
            ...
            self.positional_encoding = PosEncodingFFT(in_features=in_features, mode=fft_mode)
            in_features = self.positional_encoding.out_dim
